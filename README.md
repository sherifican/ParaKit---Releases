...
The goal of this project is to make drum chart creation as accessible as possible -- *NO* paywalls, no juggling multiple audio software and/or free web-services with ads everywhere, lower barrier to entry. ParaKit always has been and always will be free of charge and will *NEVER* host ads. If you've ever gotten tired or frustrated by the some of the unnecessarily convoluted and tedious parts of the process of chart making, or tools forcing a subscription on you, this app is for you. I've condenced all the necessities into one place.
