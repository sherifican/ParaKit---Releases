...
The goal of this project is to make the process of making MIDI charts to play in game more easily accessable without paywalls. I believe the current process is very difficult and conveluted for the average person/beginner and I aim to lower the barrier of entry. Thank you for your support!
---
...
### Custom Song Creator & All-in-One Tool — v3.5.0
...
If you're already experienced with MIDI charting and have your own workflow using tools like Reaper, Audacity, or similar — ParaKit probably isn't gonna replace your primary methods. That said, parts of it may still save you steps: the Song Creator and batch converter, Stem Splitter, Sheet Music → MIDI, Youtube → FLAC, Asset Manager/Auto MetaData Finder, and Track Preview can slot into an existing workflow without replacing it.

If you're new to charting or find dedicated audio/MIDI software difficult or confusing or frustrating or just a lot more than what you need it for then ParaKit will help you, it handles the full pipeline in one place with enough automation to get a playable chart without prior experience.
...
Selecting all 5 parts at once automatically reverts to the standard split.
...
*Created by Micah P.G. — ParaKit v3.5.0 — For the Paradiddle Community*
